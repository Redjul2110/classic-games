    ...
    container.innerHTML = `
        <div class="game-screen" style="max-width:1200px;margin:0 auto;display:flex;flex-direction:column;height:100vh;">
            ...
            <div style="display:flex;flex-wrap:wrap;gap:16px;justify-content:center;padding:8px;flex:1;overflow:hidden;min-height:0;">
                ...
                <div style="min-width:min(100%,280px);max-width:280px;background:var(--bg-card);border-radius:12px;padding:12px;border:1px solid rgba(255,255,255,0.1);overflow-y:auto;max-height:200px;display:flex;flex-direction:row;flex-wrap:wrap;gap:6px;align-content:flex-start;">
                    <h3 style="width:100%;margin-bottom:4px;font-size:0.9rem;color:var(--text-secondary);">Kings</h3>
