        ...
        <div class="game-screen" style="max-width:800px;margin:0 auto;height:100vh;display:flex;flex-direction:column;">
            ...
            <div style="flex:1;padding:clamp(12px,4vw,24px);display:flex;flex-direction:column;align-items:center;overflow-y:auto;">
                ...
                <div id="pt-play-area" style="display:none;width:100%;max-width:600px;flex-direction:column;align-items:center;">
                    ...
                    <div id="pt-answers" style="display:grid;grid-template-columns:repeat(auto-fit, minmax(min(100%, 240px), 1fr));gap:12px;width:100%;">
                        <button class="btn btn-secondary answer-btn" data-idx="0" style="min-height:56px;font-size:clamp(0.9rem,3vw,1.1rem);white-space:normal;word-break:break-word;"></button>
                        <button class="btn btn-secondary answer-btn" data-idx="1" style="min-height:56px;font-size:clamp(0.9rem,3vw,1.1rem);white-space:normal;word-break:break-word;"></button>
                        <button class="btn btn-secondary answer-btn" data-idx="2" style="min-height:56px;font-size:clamp(0.9rem,3vw,1.1rem);white-space:normal;word-break:break-word;"></button>
                        <button class="btn btn-secondary answer-btn" data-idx="3" style="min-height:56px;font-size:clamp(0.9rem,3vw,1.1rem);white-space:normal;word-break:break-word;"></button>
                    </div>
